...
from src.config import PROCESSED_DATA_DIR, create_directories, load_config
...
def main():
    ...
    if not data_path.exists():
        ...
        logger.info("Execute o script run_preprocessing.py primeiro para gerar os dados preprocessados")
        return False
