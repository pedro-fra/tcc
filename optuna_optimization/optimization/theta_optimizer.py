"""
Theta model hyperparameter optimizer using Optuna.
"""
...
class ThetaOptimizer(BaseOptimizer):
    """
    Optimizer for Theta forecasting model using Optuna.

    Performs hyperparameter optimization to find the best Theta configuration
    ...
    def __init__(
        ...
        """
        search_space = search_space or SEARCH_SPACES["theta"]
        ...
        logger.info("Theta optimizer initialized")

    def prepare_data(self):
        """
        Load and prepare data for optimization.

        This follows the same preprocessing pipeline as the Theta model.
        """
        ...
        test_ratio = self.config["theta"]["test_ratio"]
    ...
    def objective(self, trial: optuna.Trial) -> float:
        ...
        try:
            ...
            model = Theta(
                ...
                seasonality_period=season_length,
            )
