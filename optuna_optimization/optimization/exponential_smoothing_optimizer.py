"""
Exponential Smoothing model hyperparameter optimizer using Optuna.
"""
...
class ExponentialSmoothingOptimizer(BaseOptimizer):
    """
    Optimizer for Exponential Smoothing forecasting model using Optuna.

    Performs hyperparameter optimization to find the best Exponential Smoothing
    configuration for sales forecasting using Darts library.
    """
    ...
    def __init__(
        ...
        """
        Initialize Exponential Smoothing optimizer.
        ...
        """
        search_space = search_space or SEARCH_SPACES["exponential_smoothing"]
        ...
        logger.info("Exponential Smoothing optimizer initialized")

    def prepare_data(self):
        """
        Load and prepare data for optimization.

        This follows the same preprocessing pipeline as the Exponential Smoothing model.
        """
        ...
        test_ratio = self.config["exponential_smoothing"]["test_ratio"]
    ...
    def objective(self, trial: optuna.Trial) -> float:
        """
        Objective function for Exponential Smoothing optimization.
        ...
        # Extract Exponential Smoothing parameters
